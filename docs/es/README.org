...
al *derecho* (USB-OTG/JTAG) -- aparece como ~/dev/ttyACM*~.  El puerto
UART izquierdo aparece como ~/dev/ttyUSB*~ y puede entrar en conflicto
con el adaptador USB→485.  Vea la [[file:wiring.org][Referencia de cableado]] para un diagrama.
