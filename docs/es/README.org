...
El instalador solicita el puerto serial, las direcciones de clientes,
...
# Eliminar todo incluyendo configuración y datos
sudo make purge
#+end_example
...
- ~/etc/tmon/tmon.toml~ -- puerto serial, direcciones de clientes, intervalo de consulta, puerto WiFi
...
#+begin_example
sudo systemctl restart tmond-serial       # después de cambiar configuración [rs485]
...
#+begin_example
journalctl -u tmond-serial -f    # Ver lecturas RS-485 a medida que llegan.
