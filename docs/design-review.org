...
*** TODO Semantic mismatch between layers
...
Note: Agreed, implement option 1

*** TODO Dict returns where simpler types would suffice
...
Note: Agreed, dataclass.

*** TODO Magic numbers not centralized
...
Note: Agreed, everything in the config file.
...
*** TODO Schema lives in three places

Note: I wanna fix this, but let's discuss this before implementing.
...
*** TODO Address validation is scattered
