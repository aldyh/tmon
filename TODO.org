...
Add a small blurb of anything interesting that came up during working on this item, that it might be useful to keep in the archived DONE item.  Add it to the item itself in org mode.

* TODO Convert markdown files to org mode
