...
not ours.
* TODO Move ~Reading~ dataclass out of ~rs485_poller.py~
...
or to ~protocol.py~.
* TODO Extract duplicated ~_fmt()~ temperature formatter
...
* TODO Harmonize wifi/udp naming across build and code
...
* TODO Inconsistent UDP class naming
