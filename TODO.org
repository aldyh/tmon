...
* TODO Move tmon-patch out of /usr/local/bin

~tmon-patch~ is an implementation detail of ~tmon-flash~, not a
user-facing tool.  It shouldn't be on PATH.  Move it to
~/usr/local/lib/tmon/~ and update ~tmon-flash~ path resolution and
