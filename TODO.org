...
* TODO LED stub diverges from real hardware behavior
...
* TODO Stale config.toml comment references config-wifi.toml
...
per-frame.
* TODO Remove unused TMON_MAX_PAYLOAD constant
...
* TODO Add context managers to Storage and UDPReceiver
...
* TODO Validate SLAVE_ADDR range at build time
